...
public class EFT_S9_Rodolfo_Cisterna {
    ...
    static String[] menuCompras = {"[1]. Ver Sala", "[2]. Comprar Entrada ", "[3]. Verificar Disponibilidad", "[4]. Modificar su compra", "[5]. Eliminar compra, ", "[6]. Generar boleta de compra", "[7].Salir"};
